...
public class CheckboxAdapterForDefineMeeting extends BaseAdapter
{
    private List<Model> data;
    private Context context;
    private DefineMeetingFragment.AllCheckListener allCheckListener;

    public CheckboxAdapterForDefineMeeting(List<Model> data, Context context, DefineMeetingFragment.AllCheckListener allCheckListener)
    {
        this.data = data;
